...
| **Бот** | работает в фоне | Telegram-бот |
...
git remote add origin https://github.com/BuTeX/steps-competition.git
...
| `Bot not responding` | Проверь что BOT_TOKEN верный, бот запущен в фоне |
